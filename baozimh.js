/**
 * 包子漫画 - VeneraNext JS 图源
 * 站点: cn.baozimhcn.com
 * 语言: zh
 */

class BaozimhSource extends ComicSource {
    name = "包子漫画"
    key = "baozimh"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/baozimh.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "cn.baozimhcn.com", text: "cn.baozimhcn.com" }
            ],
            default: "cn.baozimhcn.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://cn.baozimhcn.com"
    }
