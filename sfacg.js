...
class Sfacg extends ComicSource {
  name = "SF轻小说";
  key = "sfacg";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/sfacg.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://mm.sfacg.com", text: "https://mm.sfacg.com (主站)" }
      ],
      default: "https://mm.sfacg.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://mm.sfacg.com";
  }
