...
class Klmanga extends ComicSource {
  name = "KL漫画";
  key = "klmanga";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/klmanga.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://klmanga.com", text: "https://klmanga.com (主站)" }
      ],
      default: "https://klmanga.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://klmanga.com";
  }
