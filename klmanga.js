/**
 * KL漫画 - VeneraNext JS 图源
 * 站点: klmanga.com
 * 语言: ko
 */

class KlmangaSource extends ComicSource {
    name = "KL漫画"
    key = "klmanga"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/klmanga.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "klmanga.com", text: "klmanga.com" }
            ],
            default: "klmanga.com"
        },
        language: {
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://klmanga.com"
    }
