...
class Sisimanhua extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/sisimanhua.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://m.sisimanhua.com", text: "https://m.sisimanhua.com (主站)" }
      ],
      default: "https://m.sisimanhua.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://m.sisimanhua.com";
  }
