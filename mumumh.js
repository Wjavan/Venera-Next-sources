...
class Mumumh extends ComicSource {
  name = "梦游漫画";
  key = "mumumh";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mumumh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.mumumh.com", text: "https://www.mumumh.com (主站)" }
      ],
      default: "https://www.mumumh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.mumumh.com";
  }
