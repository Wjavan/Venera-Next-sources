...
class Guiluoli extends ComicSource {
  name = "桂露莉漫画";
  key = "guiluoli";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/guiluoli.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.ymgjmh.com", text: "m.ymgjmh.com (主站)" }
      ],
      default: "http://m.ymgjmh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://m.ymgjmh.com";
  }
