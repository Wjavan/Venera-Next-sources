/**
 * 桂露莉漫画 - VeneraNext JS 图源
 * 站点: http://m.ymgjmh.com
 * 验证: 2026-09-19 HTTP 200
 */
class GuiluoliMH extends ComicSource {
    name = "桂露莉漫画"; key = "guiluoli"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/guiluoli.js";
    get baseUrl() { return "http://m.ymgjmh.com"; }
    ...
    explore = [{ title: "桂露莉漫画", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "桂露莉漫画分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["m.ymgjmh.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
