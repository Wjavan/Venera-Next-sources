...
class Soudongman extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/soudongman.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.soudongman.com", text: "http://m.soudongman.com (主站)" }
      ],
      default: "http://m.soudongman.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://m.soudongman.com";
  }
