...
class Migudm extends ComicSource {
  name = "咪咕动漫";
  key = "migudm";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/migudm.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://migudm.cn", text: "https://migudm.cn (主站)" }
      ],
      default: "https://migudm.cn"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://migudm.cn";
  }
