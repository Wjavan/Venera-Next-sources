...
class Gufengmh extends ComicSource {
  name = "古风漫画";
  key = "gufengmh";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/gufengmh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://m.gufengmh.com", text: "https://m.gufengmh.com (主站)" }
      ],
      default: "https://m.gufengmh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://m.gufengmh.com";
  }
