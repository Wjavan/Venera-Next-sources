...
class Mh92 extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mh92.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://www.92mh.com", text: "http://www.92mh.com (主站)" }
      ],
      default: "http://www.92mh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://www.92mh.com";
  }
