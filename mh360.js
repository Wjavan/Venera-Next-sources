...
class Mh360 extends ComicSource {
  name = "360漫画";
  key = "mh360";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mh360.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://m.100fanwo.com", text: "https://m.100fanwo.com (主站)" }
      ],
      default: "https://m.100fanwo.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://m.100fanwo.com";
  }
