...
class MangadexSource extends ComicSource {
    ...
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mangadex.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "mangadex.org", text: "mangadex.org" }
            ],
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://mangadex.org"
    }
