...
class Komiic2 extends ComicSource {
  name = "Komiic";
  key = "komiic2";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/komiic2.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://komiic.com", text: "https://komiic.com (主站)" }
      ],
