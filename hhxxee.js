...
class Hhxxee extends ComicSource {
  name = "HHXXEE";
  key = "hhxxee";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/hhxxee.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.hhxxee.com", text: "https://www.hhxxee.com (主站)" }
      ],
      default: "https://www.hhxxee.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.hhxxee.com";
  }
