/**
 * 98漫画 - VeneraNext JS 图源
 * 站点: www.98comic.com
 * 语言: zh
 */

class Comic98Source extends ComicSource {
    name = "98漫画"
    key = "comic98"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/comic98.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.98comic.com", text: "www.98comic.com" }
            ],
            default: "www.98comic.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.98comic.com"
    }
