...
class Manhuadb extends ComicSource {
  name = "漫画DB";
  key = "manhuadb";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/manhuadb.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.manhua666.cc", text: "https://www.manhua666.cc (主站)" }
      ],
      default: "https://www.manhua666.cc"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.manhua666.cc";
  }
