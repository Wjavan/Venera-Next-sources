...
class Qimanwu extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/qimanwu.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.qimanwu.org", text: "https://www.qimanwu.org (主站)" }
      ],
      default: "https://www.qimanwu.org"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.qimanwu.org";
  }
