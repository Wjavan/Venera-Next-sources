...
class Mxqf extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mxqf.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.mxshm.top", text: "https://www.mxshm.top (主站)" }
      ],
  ...
  get baseUrl() {
    return this.loadSetting("domains") || "https://www.mxshm.top";
  }
