...
class Yymanhua2 extends ComicSource {
  name = "YY漫画备用";
  key = "yymanhua2";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/yymanhua2.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.yymanhua.com", text: "https://www.yymanhua.com (主站)" }
      ],
