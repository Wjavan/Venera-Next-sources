...
class Zaimanhua extends ComicSource {
  ...
  version = "1.0.2";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/zaimanhua.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://m.zaimanhua.com", text: "m.zaimanhua.com (主站)" },
        { value: "https://www.zaimanhua.com", text: "www.zaimanhua.com (备用)" }
      ],
      default: "https://m.zaimanhua.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://m.zaimanhua.com";
  }
  ...
  explore = [{
    ...
    load: async (page) => {
      ...
      const result = {};
      let items = doc.querySelectorAll(".comic-list li, .book-list li, .comic-item, .list-item, .recommend-item");
      if (items.length > 0) {
