/**
 * 在漫画 - VeneraNext JS 图源
 * 站点: m.zaimanhua.com
 * 语言: zh
 */

class ZaimanhuaSource extends ComicSource {
    name = "在漫画"
    key = "zaimanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/zaimanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "m.zaimanhua.com", text: "m.zaimanhua.com" }
            ],
            default: "m.zaimanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://m.zaimanhua.com"
    }
