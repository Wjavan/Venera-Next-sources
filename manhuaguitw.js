/**
 * 漫画柜繁体 - VeneraNext JS 图源
 * 站点: tw.manhuagui.com
 * 语言: zh-TW
 */

class ManhuaguitwSource extends ComicSource {
    name = "漫画柜繁体"
    key = "manhuaguitw"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/manhuaguitw.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "tw.manhuagui.com", text: "tw.manhuagui.com" }
            ],
            default: "tw.manhuagui.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://tw.manhuagui.com"
    }
