/**
 * MH5 - VeneraNext JS 图源
 * 站点: www.mhua5.com
 * 语言: zh
 */

class Mhua5Source extends ComicSource {
    name = "MH5"
    key = "mhua5"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mhua5.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.mhua5.com", text: "www.mhua5.com" }
            ],
            default: "www.mhua5.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.mhua5.com"
    }
