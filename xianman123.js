...
class Xianman123 extends ComicSource {
  name = "仙漫网";
  key = "xianman123";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/xianman123.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.xianman123.com", text: "https://www.xianman123.com (主站)" }
      ],
      default: "https://www.xianman123.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.xianman123.com";
  }
