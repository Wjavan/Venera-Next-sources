...
class Dingmanhua extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/dingmanhua.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.dingmanhua.com", text: "https://www.dingmanhua.com (主站)" }
      ],
      default: "https://www.dingmanhua.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.dingmanhua.com";
  }
