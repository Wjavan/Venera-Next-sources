...
class Mh57 extends ComicSource {
  name = "MH57";
  key = "mh57";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mh57.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.wuqimh.net/", text: "http://m.wuqimh.net/ (主站)" }
      ],
      default: "http://m.wuqimh.net/"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://m.wuqimh.net/";
  }
