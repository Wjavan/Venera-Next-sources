/**
 * 漫小肆 - VeneraNext JS 图源
 * 站点: www.mxshm.top
 * 语言: ko
 */

class MxshmSource extends ComicSource {
    name = "漫小肆"
    key = "mxshm"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mxshm.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.mxshm.top", text: "www.mxshm.top" }
            ],
            default: "www.mxshm.top"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.mxshm.top"
    }
