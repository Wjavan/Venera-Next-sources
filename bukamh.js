...
class Bukamh extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/bukamh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.bukamh.org", text: "https://www.bukamh.org (主站)" }
      ],
      default: "https://www.bukamh.org"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.bukamh.org";
  }
