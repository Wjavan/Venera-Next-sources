...
class Jisumh extends ComicSource {
  name = "极速漫画";
  key = "jisumh";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/jisumh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.1kkk.com", text: "http://m.1kkk.com (主站)" }
      ],
      default: "http://m.1kkk.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://m.1kkk.com";
  }
