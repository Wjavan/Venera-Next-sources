...
class Dmzj extends ComicSource {
  name = "动漫之家";
  key = "dmzj";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/dmzj.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://m.dmzj.com", text: "https://m.dmzj.com (主站)" }
      ],
      default: "https://m.dmzj.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://m.dmzj.com";
  }
