...
class Rumanhua extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/rumanhua.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.rumanhua2.com", text: "http://m.rumanhua2.com (主站)" }
      ],
  ...
  get baseUrl() {
    return this.loadSetting("domains") || "http://m.rumanhua2.com";
  }
