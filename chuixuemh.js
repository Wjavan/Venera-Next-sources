...
class Chuixuemh extends ComicSource {
  name = "吹雪漫画";
  key = "chuixuemh";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/chuixuemh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://www.chuixue.net", text: "http://www.chuixue.net (主站)" }
      ],
      default: "http://www.chuixue.net"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://www.chuixue.net";
  }
