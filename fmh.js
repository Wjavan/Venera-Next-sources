...
class Fmh extends ComicSource {
  name = "FMH漫画";
  key = "fmh";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/fmh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://mh.fumanhua.net", text: "http://mh.fumanhua.net (主站)" }
      ],
      default: "http://mh.fumanhua.net"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://mh.fumanhua.net";
  }
