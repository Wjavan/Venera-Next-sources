...
class Manhuayu extends ComicSource {
  name = "漫画鱼";
  key = "manhuayu";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/manhuayu.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.manhuayu88.com", text: "https://www.manhuayu88.com (主站)" }
      ],
  ...
  get baseUrl() {
    return this.loadSetting("domains") || "https://www.manhuayu88.com";
  }
