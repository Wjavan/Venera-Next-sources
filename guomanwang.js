...
class Guomanwang extends ComicSource {
  name = "国漫网";
  key = "guomanwang";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/guomanwang.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.guomanwang.com", text: "https://www.guomanwang.com (主站)" }
      ],
      default: "https://www.guomanwang.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.guomanwang.com";
  }
