...
class MangabzSource extends ComicSource {
    ...
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mangabz.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.mangabz.com", text: "www.mangabz.com" }
            ],
            default: "www.mangabz.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.mangabz.com"
    }
