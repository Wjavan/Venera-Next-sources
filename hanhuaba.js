...
class Hanhuaba extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/hanhuaba.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://www.hanhuaba.com", text: "http://www.hanhuaba.com (主站)" }
      ],
      default: "http://www.hanhuaba.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://www.hanhuaba.com";
  }
