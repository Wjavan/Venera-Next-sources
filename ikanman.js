...
class Ikanman extends ComicSource {
  name = "爱看漫";
  key = "ikanman";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/ikanman.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.manhuagui.com", text: "https://www.manhuagui.com (主站)" }
      ],
