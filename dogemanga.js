...
class Dogemanga extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/dogemanga.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://dogemanga.com", text: "https://dogemanga.com (主站)" }
      ],
      default: "https://dogemanga.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://dogemanga.com";
  }
