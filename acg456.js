...
class Acg456 extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/acg456.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.acg456.com", text: "http://m.acg456.com (主站)" }
      ],
      default: "http://m.acg456.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://m.acg456.com";
  }
