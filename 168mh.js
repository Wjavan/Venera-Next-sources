/**
 * 168漫画 - VeneraNext JS 图源
 * 站点: https://m.168manhua.com
 * 验证: 2026-09-19 HTTP 200
 */
class Manhua168 extends ComicSource {
    name = "168漫画"; key = "168mh"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/168mh.js";
    get baseUrl() { return "https://m.168manhua.com"; }
    ...
    explore = [{ title: "168漫画", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "168漫画分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["m.168manhua.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
