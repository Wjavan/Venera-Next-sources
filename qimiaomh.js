...
class Qimiaomh extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/qimiaomh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.qimiaomh.com", text: "https://www.qimiaomh.com (主站)" }
      ],
      default: "https://www.qimiaomh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.qimiaomh.com";
  }
