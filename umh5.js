/**
 * 漫画屋 - VeneraNext JS 图源
 * 站点: umh5.com
 * 语言: zh
 */

class Umh5Source extends ComicSource {
    name = "漫画屋"
    key = "umh5"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/umh5.js"
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://umh5.com"
    }
