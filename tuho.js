/**
 * 土豪漫画 - VeneraNext JS 图源
 * 站点: www.tuho123.com
 * 语言: zh
 */

class TuhoSource extends ComicSource {
    name = "土豪漫画"
    key = "tuho"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/tuho.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.tuho123.com", text: "www.tuho123.com" }
            ],
            default: "www.tuho123.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.tuho123.com"
    }
