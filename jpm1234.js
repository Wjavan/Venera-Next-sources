/**
 * JPM1234 - VeneraNext JS 图源
 * 站点: http://www.jpm1234.com
 * 验证: 2026-09-19 HTTP 200
 */
class JPM1234 extends ComicSource {
    name = "JPM1234"; key = "jpm1234"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/jpm1234.js";
    get baseUrl() { return "http://www.jpm1234.com"; }
    ...
    explore = [{ title: "JPM1234", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "JPM1234分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["www.jpm1234.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
