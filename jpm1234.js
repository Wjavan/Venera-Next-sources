...
class Jpm1234 extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/jpm1234.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://www.jpm1234.com", text: "http://www.jpm1234.com (主站)" }
      ],
      default: "http://www.jpm1234.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://www.jpm1234.com";
  }
