/**
 * MangaRead - VeneraNext JS 图源
 * 站点: www.mangaread.org
 * 语言: en
 */

class MangareadSource extends ComicSource {
    name = "MangaRead"
    key = "mangaread"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mangaread.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.mangaread.org", text: "www.mangaread.org" }
            ],
            default: "www.mangaread.org"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.mangaread.org"
    }
