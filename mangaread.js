...
class Mangaread extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mangaread.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.mangaread.org", text: "https://www.mangaread.org (主站)" }
      ],
      default: "https://www.mangaread.org"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.mangaread.org";
  }
