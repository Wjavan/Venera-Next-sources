...
class Dumanwuorg extends ComicSource {
  name = "读漫屋";
  key = "dumanwuorg";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/dumanwuorg.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.dumanwu.org", text: "https://www.dumanwu.org (主站)" }
      ],
      default: "https://www.dumanwu.org"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.dumanwu.org";
  }
