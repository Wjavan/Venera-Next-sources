...
class Mh522 extends ComicSource {
  name = "522漫画";
  key = "mh522";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mh522.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.522manhua.com", text: "http://m.522manhua.com (主站)" }
      ],
      default: "http://m.522manhua.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://m.522manhua.com";
  }
