/**
 * CCC追漫台 - VeneraNext JS 图源
 * 站点: www.creative-comic.tw
 * 语言: zh-TW
 */

class CreativecomicSource extends ComicSource {
    name = "CCC追漫台"
    key = "creativecomic"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/creativecomic.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.creative-comic.tw", text: "www.creative-comic.tw" }
            ],
            default: "www.creative-comic.tw"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.creative-comic.tw"
    }
