...
class Youdm extends ComicSource {
  name = "优动漫";
  key = "youdm";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/youdm.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.udm123.com", text: "https://www.udm123.com (主站)" }
      ],
      default: "https://www.udm123.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.udm123.com";
  }
