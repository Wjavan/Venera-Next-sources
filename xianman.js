/**
 * 仙漫网 - VeneraNext JS 图源
 * 站点: www.xianman123.com
 * 语言: zh
 */

class XianmanSource extends ComicSource {
    name = "仙漫网"
    key = "xianman"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/xianman.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.xianman123.com", text: "www.xianman123.com" }
            ],
            default: "www.xianman123.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.xianman123.com"
    }
