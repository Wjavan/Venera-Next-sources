...
class Gamersky extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/gamersky.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://acg.gamersky.com/manhua", text: "http://acg.gamersky.com/manhua (主站)" }
      ],
      default: "http://acg.gamersky.com/manhua"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://acg.gamersky.com/manhua";
  }
