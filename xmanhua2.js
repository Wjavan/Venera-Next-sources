...
class Xmanhua2 extends ComicSource {
  name = "X漫画备用";
  key = "xmanhua2";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/xmanhua2.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://xmanhua.com", text: "https://xmanhua.com (主站)" }
      ],
