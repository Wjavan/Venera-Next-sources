/**
 * 漫画1234 - VeneraNext JS 图源
 * 站点: www.wmh1234.com
 * 语言: zh
 */

class Wmh1234Source extends ComicSource {
    name = "漫画1234"
    key = "wmh1234"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/wmh1234.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.wmh1234.com", text: "www.wmh1234.com" }
            ],
            default: "www.wmh1234.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.wmh1234.com"
    }
