...
class U17 extends ComicSource {
  name = "有妖气";
  key = "u17";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/u17.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://u17.com", text: "https://u17.com (主站)" }
      ],
      default: "https://u17.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://u17.com";
  }
