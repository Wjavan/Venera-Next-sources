...
class Colamanga extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/colamanga.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.colamanga.com", text: "https://www.colamanga.com" }
      ],
      default: "https://www.colamanga.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.colamanga.com";
  }
