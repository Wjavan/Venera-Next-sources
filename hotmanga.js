...
class Hotmanga extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/hotmanga.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.manga2024.com/", text: "https://www.manga2024.com/ (主站)" }
      ],
      default: "https://www.manga2024.com/"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.manga2024.com/";
  }
