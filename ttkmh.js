...
class Ttkmh extends ComicSource {
  name = "天天看漫画";
  key = "ttkmh";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/ttkmh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.ttkmh.com", text: "https://www.ttkmh.com (主站)" }
      ],
      default: "https://www.ttkmh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.ttkmh.com";
  }
  ...
  parseComic(item) {
    ...
    const update = item.querySelector(".manga-1-list-subtitle, .update, .chapter")?.text?.trim() || "";
  ...
  explore = [{
    ...
    load: async (page) => {
      ...
      const result = {};
      let items = doc.querySelectorAll(".manga-1-list-item, .manga-i-list-item, .comic-item, .list-item");
      if (items.length > 0) {
