/**
 * 梦游漫画 - VeneraNext JS 图源
 * 站点: www.mumumh.com
 * 语言: ko
 */

class MumumhSource extends ComicSource {
    name = "梦游漫画"
    key = "mumumh"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mumumh.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.mumumh.com", text: "www.mumumh.com" }
            ],
            default: "www.mumumh.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.mumumh.com"
    }
