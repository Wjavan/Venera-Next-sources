/**
 * 入漫画 (RUMANHUA) - VeneraNext JS 图源
 * 站点: http://m.rumanhua2.com
...
class Rumanhua extends ComicSource {
    ...
    version = "1.0.0";
    minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/rumanhua.js";

    get baseUrl() { return "http://m.rumanhua2.com"; }
    ...
    explore = [{ title: "入漫画", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "入漫画分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["m.rumanhua2.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
        idMatch: "^(\\d+|[\\w-]+)$",
