/**
 * MX趣 - VeneraNext JS 图源
 * 站点: http://www.mxqf.com
 * 验证: 2026-09-19 HTTP 200
 */
class MXQF extends ComicSource {
    name = "MX趣"; key = "mxqf"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mxqf.js";
    get baseUrl() { return "http://www.mxqf.com"; }
    ...
    explore = [{ title: "MX趣", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "MX趣分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["www.mxqf.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
