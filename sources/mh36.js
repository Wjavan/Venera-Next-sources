/**
 * 36漫画 - VeneraNext JS 图源
 * 站点: www.36mh.org
 * 语言: zh
 */

class Mh36Source extends ComicSource {
    name = "36漫画"
    key = "mh36"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/mh36.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.36mh.org", text: "www.36mh.org" }
            ],
            default: "www.36mh.org"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.36mh.org"
    }
