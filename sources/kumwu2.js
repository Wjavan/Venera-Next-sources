/**
 * 酷漫画2 - VeneraNext JS 图源
 * 站点: http://www.kumwu2.com
 * 验证: 2026-09-19 HTTP 200
 */
class Kumwu2 extends ComicSource {
    name = "酷漫画2"; key = "kumwu2"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/kumwu2.js";
    get baseUrl() { return "http://www.kumwu2.com"; }
    ...
    explore = [{ title: "酷漫画2", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "酷漫画2分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["www.kumwu2.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
