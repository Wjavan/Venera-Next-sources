/**
 * Colamanga - VeneraNext JS 图源
 * 站点: www.colamanga.com
 * 语言: ko
 */

class ColamangaSource extends ComicSource {
    name = "Colamanga"
    key = "colamanga"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/colamanga.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.colamanga.com", text: "www.colamanga.com" }
            ],
            default: "www.colamanga.com"
        },
        language: {
            title: "语言",
            type: "select",
            options: [{ value: "ko", text: "한국어" }],
            default: "ko"
        }
    }

    get baseUrl() {
        return this.loadSetting("domain") || "https://www.colamanga.com"
    }
