/**
 * 古风王 - VeneraNext JS 图源
 * 站点: https://m.gufengmanhua.com
 * 验证: 2026-09-19 HTTP 200
 */
class GuFengWang extends ComicSource {
    name = "古风王"; key = "gufengwang"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/gufengwang.js";
    get baseUrl() { return "https://m.gufengmanhua.com"; }
    ...
    explore = [{ title: "古风王", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "古风王分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["m.gufengmanhua.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
