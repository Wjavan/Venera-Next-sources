/**
 * 手机漫画 - VeneraNext JS 图源
 * 站点: www.gmanhua.com
 * 语言: zh
 */

class GmanhuaSource extends ComicSource {
    name = "手机漫画"
    key = "gmanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/gmanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.gmanhua.com", text: "www.gmanhua.com" }
            ],
            default: "www.gmanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.gmanhua.com"
    }
