/**
 * 国漫网 - VeneraNext JS 图源
 * 站点: www.guomanwang.com
 * 语言: zh
 */

class GuomanwangSource extends ComicSource {
    name = "国漫网"
    key = "guomanwang"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/guomanwang.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.guomanwang.com", text: "www.guomanwang.com" }
            ],
            default: "www.guomanwang.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.guomanwang.com"
    }
