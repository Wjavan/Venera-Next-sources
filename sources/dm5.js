/**
 * 动漫屋 - VeneraNext JS 图源
 * 站点: https://m.dm5.com
 * 验证: 2026-09-19 HTTP 200
 */
class DM5 extends ComicSource {
    name = "动漫屋"; key = "dm5"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/dm5.js";
    ...
    explore = [{ title: "动漫屋", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "动漫屋分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["m.dm5.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
