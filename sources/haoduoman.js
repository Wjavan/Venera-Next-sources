/**
 * 好多漫画 - VeneraNext JS 图源
 *
 * 移植自 Cimoc JSON 配置 (HAODUOMAN)
 * 站点: https://www.haoduoman.com
 * 验证时间: 2026-09-19 (HTTP 200)
 */

class HaoduomanMH extends ComicSource {
    name = "好多漫画";
    key = "haoduoman";
    version = "1.0.0";
    minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/haoduoman.js";
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "https://www.haoduoman.com", text: "haoduoman.com" },
            ],
    ...
    comic = {
        ...
        link: {
            domains: ["haoduoman.com", "www.haoduoman.com"],
            linkToId: (url) => {
