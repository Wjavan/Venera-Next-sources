/**
 * YY漫画 - VeneraNext JS 图源
 * 站点: www.yymanhua.com
 * 语言: zh
 */

class YymanhuaSource extends ComicSource {
    name = "YY漫画"
    key = "yymanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/yymanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.yymanhua.com", text: "www.yymanhua.com" }
            ],
            default: "www.yymanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.yymanhua.com"
    }
