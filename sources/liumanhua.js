/**
 * 流漫画 - VeneraNext JS 图源
 * 站点: www.liumanhua.com
 * 语言: zh
 */

class LiumanhuaSource extends ComicSource {
    name = "流漫画"
    key = "liumanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/liumanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.liumanhua.com", text: "www.liumanhua.com" }
            ],
            default: "www.liumanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.liumanhua.com"
    }
