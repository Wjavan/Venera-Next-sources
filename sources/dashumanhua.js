/**
 * 大树漫画 - VeneraNext JS 图源
 * 站点: www.dashumanhua.com
 * 语言: zh
 */

class DashumanhuaSource extends ComicSource {
    name = "大树漫画"
    key = "dashumanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/dashumanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.dashumanhua.com", text: "www.dashumanhua.com" }
            ],
            default: "www.dashumanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.dashumanhua.com"
    }
