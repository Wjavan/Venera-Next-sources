/**
 * 拷贝漫画 - VeneraNext JS 图源
 * 站点: www.copy20.com
 * 语言: zh
 */

class Copy20Source extends ComicSource {
    name = "拷贝漫画"
    key = "copy20"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/copy20.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.copy20.com", text: "www.copy20.com" }
            ],
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.copy20.com"
    }
