/**
 * X漫画 - VeneraNext JS 图源
 * 站点: xmanhua.com
 * 语言: ja
 */

class XmanhuaSource extends ComicSource {
    name = "X漫画"
    key = "xmanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/xmanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "xmanhua.com", text: "xmanhua.com" }
            ],
            default: "xmanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
            options: [{ value: "ja", text: "日本語" }],
            default: "ja"
        }
    }

    get baseUrl() {
        return this.loadSetting("domain") || "https://xmanhua.com"
    }
