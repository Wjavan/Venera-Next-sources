/**
 * 西西漫画 - VeneraNext JS 图源
 * 站点: m.sisimanhua.com
 * 语言: zh
 */

class SisimanhuaSource extends ComicSource {
    name = "西西漫画"
    key = "sisimanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/sisimanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "m.sisimanhua.com", text: "m.sisimanhua.com" }
            ],
            default: "m.sisimanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://m.sisimanhua.com"
    }
