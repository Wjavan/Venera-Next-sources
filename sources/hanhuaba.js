/**
 * 韩话吧 - VeneraNext JS 图源
 * 站点: http://www.hanhuaba.com
 * 验证: 2026-09-19 HTTP 200
 */
class Hanhuaba extends ComicSource {
    name = "韩话吧"; key = "hanhuaba"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/hanhuaba.js";
    get baseUrl() { return "http://www.hanhuaba.com"; }
    ...
    explore = [{ title: "韩话吧", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "韩话吧分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["www.hanhuaba.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
