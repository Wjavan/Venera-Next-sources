/**
 * 一本漫画 - VeneraNext JS 图源
 * 站点: www.yibenmanhua.com
 * 语言: zh
 */

class YibenmanhuaSource extends ComicSource {
    name = "一本漫画"
    key = "yibenmanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/yibenmanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.yibenmanhua.com", text: "www.yibenmanhua.com" }
            ],
            default: "www.yibenmanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.yibenmanhua.com"
    }
