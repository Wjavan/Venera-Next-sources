...
class ManbenSource extends ComicSource {
    name = "漫本"
    key = "manben"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/manben.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.manben.com", text: "www.manben.com" }
            ],
            default: "www.manben.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.manben.com"
    }
