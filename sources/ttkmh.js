/**
 * 天天看漫画 - VeneraNext JS 图源
 * 站点: www.ttkmh.com
 * 语言: zh
 */

class TtkmhSource extends ComicSource {
    name = "天天看漫画"
    key = "ttkmh"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/ttkmh.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.ttkmh.com", text: "www.ttkmh.com" }
            ],
            default: "www.ttkmh.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.ttkmh.com"
    }
