/**
 * ACG456 - VeneraNext JS 图源
 * 站点: http://m.acg456.com
 * 验证: 2026-09-19 HTTP 200
 */
class ACG456 extends ComicSource {
    name = "ACG456"; key = "acg456"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/acg456.js";
    get baseUrl() { return "http://m.acg456.com"; }
    ...
    explore = [{ title: "ACG456", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "ACG456分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["m.acg456.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
