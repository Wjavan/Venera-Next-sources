/**
 * 极速漫画 - VeneraNext JS 图源
 * 站点: m.1kkk.com
 * 语言: zh
 */

class JisuSource extends ComicSource {
    name = "极速漫画"
    key = "jisu"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/jisu.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "m.1kkk.com", text: "m.1kkk.com" }
            ],
            default: "m.1kkk.com"
        },
        language: {
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://m.1kkk.com"
    }
