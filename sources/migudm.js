/**
 * 咪咕动漫 - VeneraNext JS 图源
 * 站点: www.migudm.cn
 * 语言: zh
 */

class MigudmSource extends ComicSource {
    name = "咪咕动漫"
    key = "migudm"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/migudm.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.migudm.cn", text: "www.migudm.cn" }
            ],
            default: "www.migudm.cn"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.migudm.cn"
    }
