/**
 * 哥达漫画2 - VeneraNext JS 图源
 * 站点: https://m.g-mh.org
 * 验证: 2026-09-19 HTTP 200
 */
class GMH2 extends ComicSource {
    name = "哥达漫画2"; key = "gmh2"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/gmh2.js";
    get baseUrl() { return "https://m.g-mh.org"; }
    ...
    explore = [{ title: "哥达漫画2", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "哥达漫画2分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["m.g-mh.org"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
