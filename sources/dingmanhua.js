/**
 * 丁漫画 - VeneraNext JS 图源
 * 站点: www.dingmanhua.com
 * 语言: zh
 */

class DingmanhuaSource extends ComicSource {
    name = "丁漫画"
    key = "dingmanhua"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/dingmanhua.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.dingmanhua.com", text: "www.dingmanhua.com" }
            ],
            default: "www.dingmanhua.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.dingmanhua.com"
    }
