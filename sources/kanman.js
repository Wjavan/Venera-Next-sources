/**
 * 漫画台 - VeneraNext JS 图源
 * 站点: www.kanman.com
 * 语言: zh
 */

class KanmanSource extends ComicSource {
    name = "漫画台"
    key = "kanman"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/kanman.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "www.kanman.com", text: "www.kanman.com" }
            ],
            default: "www.kanman.com"
        },
        language: {
            title: "语言",
            type: "select",
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://www.kanman.com"
    }
