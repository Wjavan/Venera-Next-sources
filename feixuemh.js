...
class Feixuemh extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/feixuemh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.feixuemh.com", text: "https://www.feixuemh.com (主站)" }
      ],
      default: "https://www.feixuemh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.feixuemh.com";
  }
