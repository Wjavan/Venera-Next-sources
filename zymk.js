...
class Zymk extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/zymk.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://m.zymk.cn", text: "https://m.zymk.cn (主站)" }
      ],
      default: "https://m.zymk.cn"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://m.zymk.cn";
  }
