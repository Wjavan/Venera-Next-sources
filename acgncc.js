/**
 * ACGN漫画 (ACGNCC) - VeneraNext JS 图源
 * 站点: https://comic.acgn.cc
 * 验证: 2026-09-19 HTTP 200
 */
class ACGNCC extends ComicSource {
    name = "ACGN漫画";
    key = "acgncc";
    version = "1.0.0";
    minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/acgncc.js";

    get baseUrl() { return "https://comic.acgn.cc"; }
    ...
    explore = [{ title: "ACGN漫画", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "ACGN漫画分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["comic.acgn.cc"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
        idMatch: "^(\\d+|[\\w-]+)$",
