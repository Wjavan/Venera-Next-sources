...
class Mkzhan extends ComicSource {
  ...
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mkzhan.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://comic.mkzhan.com", text: "https://comic.mkzhan.com (主站)" }
      ],
      default: "https://comic.mkzhan.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://comic.mkzhan.com";
  }
