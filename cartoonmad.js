...
class Cartoonmad extends ComicSource {
  name = "CartoonMad";
  key = "cartoonmad";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/cartoonmad.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.cartoonmad.com", text: "https://www.cartoonmad.com (主站)" }
      ],
      default: "https://www.cartoonmad.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.cartoonmad.com";
  }
