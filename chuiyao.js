...
class Chuiyao extends ComicSource {
  name = "吹妖漫画";
  key = "chuiyao";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/chuiyao.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "http://m.chuiyao.com", text: "http://m.chuiyao.com (主站)" }
      ],
      default: "http://m.chuiyao.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "http://m.chuiyao.com";
  }
