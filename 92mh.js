/**
 * 92漫画 - VeneraNext JS 图源
 * 站点: http://www.92mh.com
 * 验证: 2026-09-19 HTTP 200
 */
class MH92 extends ComicSource {
    name = "92漫画"; key = "92mh"; version = "1.0.0"; minAppVersion = "1.6.0";
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/92mh.js";
    get baseUrl() { return "http://www.92mh.com"; }
    ...
    explore = [{ title: "92漫画", type: "singlePageWithMultiPart", load: async () => {
    ...
    category = { title: "92漫画分类", parts: [{ name: "全部", type: "fixed", categories: [
    ...
    comic = {
        ...
        link: { domains: ["www.92mh.com"], linkToId: (url) => { let m = url.match(/\/comic\/([\d\w-]+)/) || url.match(/\/([\d\w-]+)(?:_\d+)?\.?html?$/); return m ? m[1] : null; } },
