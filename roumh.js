...
class Roumh extends ComicSource {
  name = "Rou韩漫";
  key = "roumh";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/roumh.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://m.roumh.com", text: "https://m.roumh.com (主站)" }
      ],
      default: "https://m.roumh.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://m.roumh.com";
  }
