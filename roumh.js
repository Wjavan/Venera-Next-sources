/**
 * Rou韩漫 - VeneraNext JS 图源
 * 站点: m.roumh.com
 * 语言: ko
 */

class RoumhSource extends ComicSource {
    name = "Rou韩漫"
    key = "roumh"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://cdn.jsdelivr.net/gh/yourname/venera-sources@main/roumh.js"
    ...
    settings = {
        domain: {
            ...
            type: "select",
            options: [
                { value: "m.roumh.com", text: "m.roumh.com" }
            ],
            default: "m.roumh.com"
        },
        language: {
    ...
    get baseUrl() {
        return this.loadSetting("domain") || "https://m.roumh.com"
    }
