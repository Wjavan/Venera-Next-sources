...
class Mkzhanw extends ComicSource {
  name = "MKZHANW";
  key = "mkzhanw";
  version = "1.0.0";
  minAppVersion = "1.6.0";
  url = "https://cdn.jsdelivr.net/gh/Wjavan/venera-next-sources@main/mkzhanw.js";
  ...
  settings = {
    domains: {
      ...
      type: "select",
      options: [
        { value: "https://www.mkzhan.com", text: "https://www.mkzhan.com (主站)" }
      ],
      default: "https://www.mkzhan.com"
    }
  };

  get baseUrl() {
    return this.loadSetting("domains") || "https://www.mkzhan.com";
  }
